    ...
    <div class="w-full sm:px-6">
      <div class="px-4 py-4 md:px-10 md:py-7">
        <div class="flex items-center justify-between">
          ...
          <div class="flex cursor-pointer items-center rounded bg-gray-200 py-3 px-4 text-sm font-medium leading-none text-gray-600 hover:bg-gray-300">
            <p>Sort By:</p>
      ...
      <div class="bg-white py-4 px-4 md:py-7 md:px-8 xl:px-10">
          ...
          <table class="w-full whitespace-nowrap">
            <tbody>
              ...
              <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                ...
                <td class="">
                  <div class="flex items-center pl-5">
                    <p class="mr-2 text-base font-medium leading-none text-gray-700">Marketing Keynote Presentation</p>
                ...
                <td class="pl-4">
                  <button class="rounded bg-gray-100 py-3 px-5 text-sm leading-none text-gray-600 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-red-300 focus:ring-offset-2">
                    View
                  </button>
                </td>
                <td>
              ...
              <tr tabindex="0" class="h-16 rounded border border-gray-100 focus:outline-none">
                ...
                <td class="">
                  <div class="flex items-center pl-5">
                    <p class="mr-2 text-base font-medium leading-none text-gray-700">Vue integration</p>
                  </div>
                </td>
                <td class="pl-24">
                  <div class="flex items-center">
                ...
                <td class="pl-5">
                  <button class="rounded bg-gray-100 py-3 px-3 text-sm leading-none text-gray-700 hover:bg-gray-200 focus:outline-none">
                    Due Today at 18:00
                  </button>
                </td>
                <td class="pl-4">
